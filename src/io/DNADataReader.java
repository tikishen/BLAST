...
public class DNADataReader extends DNASeqReader
{
     ...
     *                reading.
     */
    public List<DNASequenceInfo> readData()    // *** Replace void with the data structure type ***
    {
        // *** Create a data structure here to hold the entire database ***
        // *** of sequence info ***
        List<DNASequenceInfo> dnaSequenceInfos = new ArrayList<DNASequenceInfo>();
        ...
        try 
        {
            ...
            while ( (next = this.readLine()) != null) 
            {
                ...
                if ( ! next.equals("") )
                    dnaSequenceInfos.add(readInfoForOneSequence(next));
            }
        } 
        catch (IOException e) 
        {
     ...
     *      @throws IOException
     */
    private DNASequenceInfo readInfoForOneSequence(String firstLine) throws IOException
    {
        ...
        return new DNASequenceInfo(gi, desc, seq);
    }
}
